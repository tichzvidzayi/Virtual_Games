  ...
  return (
    <>
      <div className='bg-[url("footerbg.png")] w-full bg-cover bg-no-repeat mix-blend-color-dodge py-10 px-6'>
        ...
        <div className="relative z-10 flex flex-wrap justify-between items-start pt-6 pb-6 gap-6 md:gap-10">
        ...
        {/* Brand Logos */}
        <div className="relative z-10 flex justify-between items-center gap-6 py-4 flex-wrap">
          {[
            "twitch.png",
            "roblox.png",
            "asus.png",
